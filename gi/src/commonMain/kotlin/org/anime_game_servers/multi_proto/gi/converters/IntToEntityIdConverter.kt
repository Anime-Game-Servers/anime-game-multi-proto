...
object IntToEntityIdConverter : TypeConverter<Int, EntityId> {
    override fun inToOut(inData: Int, version: Version) = VersionUtils.entityIdConverter(inData, version)

    override fun outToIn(outData : EntityId, version: Version) = VersionUtils.toProtoEntityId(outData.id, outData.typeId, version)
}
