...
interface FoundationInfo {
    var status: org.anime_game_servers.multi_proto.gi.data.gadget.FoundationStatus
    ...
    @RemovedIn(GI_2_6_0)
    var buildingList: List<org.anime_game_servers.multi_proto.gi.data.gadget.BuildingInfo>
    @RemovedIn(GI_2_6_0)
    var currentNum: Int
    @RemovedIn(GI_2_6_0)
