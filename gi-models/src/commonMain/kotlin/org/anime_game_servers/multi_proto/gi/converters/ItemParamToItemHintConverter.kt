...
object ItemParamToItemHintConverter : TypeConverter<ItemParamImpl, ItemHintImpl> {
    override fun inToOut(inData: ItemParamImpl, version: Version): ItemHintImpl = ItemHintImpl(count = inData.count, itemId = inData.itemId)
    override fun outToIn(outData: ItemHintImpl, version: Version): ItemParamImpl = ItemParamImpl(count = outData.count, itemId = outData.itemId)
}