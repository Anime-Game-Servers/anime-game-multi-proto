...
object GmShapeToObstacleShapeConverter : TypeConverter<GMObstacleShapeTypeImpl, ShapeTypeImpl> {
    override fun inToOut(inData: GMObstacleShapeTypeImpl, version: Version): ShapeTypeImpl = when(inData){
    ...
    override fun outToIn(outData: ShapeTypeImpl, version: Version): GMObstacleShapeTypeImpl = when(outData){
